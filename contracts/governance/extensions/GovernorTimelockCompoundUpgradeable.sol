...
abstract contract GovernorTimelockCompoundUpgradeable is Initializable, IGovernorTimelockUpgradeable, GovernorUpgradeable {
    ...
    function proposalEta(uint256 proposalId) public view virtual override returns (uint256) {
        return GovernorTimelockCompoundStorage.layout()._proposalTimelocks[proposalId];
    }
    ...
    function queue(
        ...
        GovernorTimelockCompoundStorage.layout()._proposalTimelocks[proposalId] = SafeCastUpgradeable.toUint64(eta);
    ...
    function _cancel(
        ...
        if (eta > 0) {
            // update state first
            delete GovernorTimelockCompoundStorage.layout()._proposalTimelocks[proposalId];
