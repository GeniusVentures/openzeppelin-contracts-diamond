...
abstract contract GovernorVotesQuorumFractionUpgradeable is Initializable, GovernorVotesUpgradeable {
    ...
    function quorum(uint256 blockNumber) public view virtual override returns (uint256) {
        return (GovernorVotesStorage.layout().token.getPastTotalSupply(blockNumber) * quorumNumerator()) / quorumDenominator();
    }
    ...
    function _updateQuorumNumerator(uint256 newQuorumNumerator) internal virtual {
        ...
        uint256 oldQuorumNumerator = GovernorVotesQuorumFractionStorage.layout()._quorumNumerator;
        GovernorVotesQuorumFractionStorage.layout()._quorumNumerator = newQuorumNumerator;
