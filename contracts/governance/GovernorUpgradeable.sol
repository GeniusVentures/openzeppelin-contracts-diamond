...
abstract contract GovernorUpgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, EIP712Upgradeable, IGovernorUpgradeable, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
    ...
    function proposalSnapshot(uint256 proposalId) public view virtual override returns (uint256) {
        return GovernorStorage.layout()._proposals[proposalId].voteStart;
    }
    ...
    function proposalDeadline(uint256 proposalId) public view virtual override returns (uint256) {
        return GovernorStorage.layout()._proposals[proposalId].voteEnd;
    }
    ...
    function proposalProposer(uint256 proposalId) public view virtual override returns (address) {
        return GovernorStorage.layout()._proposals[proposalId].proposer;
    }
    ...
    function propose(
        ...
        require(GovernorStorage.layout()._proposals[proposalId].voteStart == 0, "Governor: proposal already exists");

        uint256 snapshot = currentTimepoint + votingDelay();
        uint256 deadline = snapshot + votingPeriod();

        GovernorStorage.layout()._proposals[proposalId] = ProposalCore({
            proposer: proposer,
    ...
    function cancel(
        ...
        require(_msgSender() == GovernorStorage.layout()._proposals[proposalId].proposer, "Governor: only proposer can cancel");
