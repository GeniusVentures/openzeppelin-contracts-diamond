...
library EnumerableBytes32SetMockStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzepplin.contracts.storage.EnumerableBytes32SetMock');
...
library EnumerableAddressSetMockStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzepplin.contracts.storage.EnumerableAddressSetMock');
...
library EnumerableUintSetMockStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzepplin.contracts.storage.EnumerableUintSetMock');
