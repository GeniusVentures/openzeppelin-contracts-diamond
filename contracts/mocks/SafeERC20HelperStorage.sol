...
library ERC20ReturnFalseMockStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzeppelin.contracts.storage.ERC20ReturnFalseMock');
...
library ERC20ReturnTrueMockStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzeppelin.contracts.storage.ERC20ReturnTrueMock');
...
library ERC20NoReturnMockStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzeppelin.contracts.storage.ERC20NoReturnMock');
...
library SafeERC20WrapperStorage {
  ...
  bytes32 internal constant STORAGE_SLOT = keccak256('openzeppelin.contracts.storage.SafeERC20Wrapper');
